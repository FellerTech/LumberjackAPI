...
namespace Lumberjack {
  ...
  /**
   * \brief interface class for inserting data into Lumberjack
   * 
   * This class primarliy provides functions to inserting log data into 
   * the system. There is also support for querying version information.
   **/
